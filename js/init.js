...
*/
var giturl = "https://rawcdn.githack.com/wildlifeward/wildlifeward.github.io/864290afd1d777c21a1c1945d7aa9f363252df02/theme"
skel.init({
	reset: 'full',
	breakpoints: {
		global:		{ range: '*', href: giturl+'/css/style.css', containers: 1400, grid: { gutters: 50 } },
		wide:		{ range: '-1680', href: giturl+'/css/style-wide.css', containers: 1200, grid: { gutters: 40 } },
		normal:		{ range: '-1280', href: giturl+'/css/style-normal.css', containers: 960, lockViewport: true },
		narrow:		{ range: '-980', href: giturl+'/css/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
		narrower:	{ range: '-840', href: giturl+'/css/style-narrower.css', grid: { collapse: 1 } },
		mobile:		{ range: '-640', href: giturl+'/css/style-mobile.css', containers: '100%', grid: { gutters: 15, collapse: 2 } }
	}
}, {
	layers: {
